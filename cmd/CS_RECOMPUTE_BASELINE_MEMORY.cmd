COMMAND CFS CS_RECOMPUTE_BASELINE_MEMORY BIG_ENDIAN "Recompute the baseline checksum of the Memory table entry and use that value as the new baseline. This command spawns a child task to do the recompute."
