COMMAND CFS CS_ENABLE_APPS BIG_ENDIAN "Allow the App table to checksummed in the background"
  ...
  APPEND_PARAMETER CCSDS_FC 8 UINT MIN_UINT8 MAX_UINT8 34 "CCSDS Command Function Code"
